...
class Project(models.Model):
    ...
    project_manager = models.ForeignKey(Manager.id_manager, on_delete=models.CASCADE)
...
class Employee(models.Model):
    ...
    employee_project = models.ForeignKey(Project.id_project, on_delete=models.CASCADE)
...
class Task(models.Model):
    ...
    task_project = models.ForeignKey(Project.id_project, on_delete=models.CASCADE)
...
class Milestone(models.Model):
    ...
    milestone_project = models.ForeignKey(Project.id_project, on_delete=models.CASCADE)


class working_on(models.Model):

    working_on_task = models.ForeignKey(Task.id_task, on_delete=models.CASCADE)
    working_on_employee = models.ForeignKey(Employee.id_employee, on_delete=models.CASCADE)
